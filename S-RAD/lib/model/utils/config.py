...
__C.RESNET.FIXED_BLOCKS_1 = 1
__C.RESNET.FIXED_BLOCKS_2 = 0
...
__C.LOG.URFD_LOG_DIR = "/mnt/AI_RAID/UR_fall_detection/logs"
__C.LOG.IMFD_LOG_DIR = "/mnt/AI_RAID/imvia_falldataset/logs"
...
# -----------------------------------------------------------------------------
# UCFSPORT Dataset options
# -----------------------------------------------------------------------------
# Directory path of frames.
__C.UCFSPORT =edict()

# Output model directory
__C.UCFSPORT.output_model_dir = "/mnt/AI_RAID/UCF-Sports-Actions/models"

# num of classes 
__C.UCFSPORT.NUM_CLASSES = 11

# # Directory path for files of frame lists.
__C.UCFSPORT.FRAME_LIST_DIR = ("/mnt/AI_RAID/UCF-Sports-Actions/frames_list/"
)

# Directory path for annotation files.
__C.UCFSPORT.ANNOTATION_DIR = (
    "/mnt/AI_RAID/UCF-Sports-Actions/ucfsports-anno/"
)
# Directory path of frames.
__C.UCFSPORT.FRAME_DIR = "/mnt/AI_RAID/UCF-Sports-Actions/Frames"
...
# Output model directory
__C.URFD.output_model_dir = "/mnt/AI_RAID/UR_fall_detection/models"

# num of classes 
__C.URFD.NUM_CLASSES = 3

# # Directory path for files of frame lists.
__C.URFD.FRAME_LIST_DIR = (
    "/mnt/AI_RAID/UR_fall_detection/train_test_split_files/"
)

# Directory path of frames.
__C.URFD.FRAME_DIR = "/mnt/AI_RAID/UR_fall_detection/images/URFD_images/"

__C.URFD.INPUT_MEAN = [0.485, 0.456, 0.406]
__C.URFD.INPUT_STD  = [0.229, 0.224, 0.225]


# -----------------------------------------------------------------------------
# Imvia fall Dataset options
# -----------------------------------------------------------------------------
# Directory path of frames.
__C.IMFD =edict()

# Output model directory
__C.IMFD.output_model_dir = "/mnt/AI_RAID/imvia_falldataset/models"

# num of classes 
__C.IMFD.NUM_CLASSES = 3

# # Directory path for files of frame lists.
__C.IMFD.FRAME_LIST_DIR = (
    "/mnt/AI_RAID/imvia_falldataset/Train_test_splits/"
)

# Directory path of frames.
__C.IMFD.FRAME_DIR = "/mnt/AI_RAID/imvia_falldataset/"

__C.IMFD.INPUT_MEAN = [0.485, 0.456, 0.406]
__C.IMFD.INPUT_STD  = [0.229, 0.224, 0.225]
...
__C.JHMDB.FRAME_LIST_DIR = (
    "/mnt/AI_RAID/jhmdb/original_annotation/"
)
