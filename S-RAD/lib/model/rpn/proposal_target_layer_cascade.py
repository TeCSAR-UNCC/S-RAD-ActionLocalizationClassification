...
class _ProposalTargetLayer(nn.Module):
    ...
    def forward(self, all_rois, gt_boxes, num_boxes,val =0):
        ...
        num_images = 1
        if val:
         cfg.TEST.BATCH_SIZE = 300
         rois_per_image = int(cfg.TEST.BATCH_SIZE / num_images)
        ...
        if val:
           rois_label=self.create_val_rois_label(all_rois, gt_boxes, fg_rois_per_image, 
    ...
    def create_val_rois_label(self, all_rois, gt_boxes, fg_rois_per_image, rois_per_image, num_classes):
        """Generate a random sample of RoIs comprising foreground and background
        examples.
        """
        # overlaps: (rois x gt_boxes)
