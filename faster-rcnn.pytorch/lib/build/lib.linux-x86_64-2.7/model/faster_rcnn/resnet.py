...
class resnet(_fasterRCNN):
  ...
  #
  # added temporal shift to the base feature extractor
  ...
  #data augmentation depending on the architecture
  def get_augmentation(self, flip=True):
    if self.modality == 'RGB':
      if flip:
        return torchvision.transforms.Compose([GroupScale(self.input_size),
